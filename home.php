            ...
            <section class="platform-view is-active-view" id="inicio" data-view="inicio" aria-label="Resumo do dia">
                ...
                <section class="mood-checkin" aria-labelledby="moodCheckinTitle">
                    <div>
                        ...
                        <h3 id="moodCheckinTitle">Como voc&ecirc; est&aacute; hoje?</h3>
                        <p id="moodFeedback">Escolha uma carinha para registrar como voc&ecirc; se sente agora.</p>
                    </div>
                ...
                <div class="report-summary">
                    <article class="report-card">
                        ...
                        <div>
                            ...
                            <p>Cores, alfabeto, vogais, s&iacute;labas, n&uacute;meros e matem&aacute;tica visual.</p>
                        </div>
                    </article>
                    <article class="report-card">
                        ...
                        <div>
                            ...
                            <p>Comunica&ccedil;&atilde;o, matem&aacute;tica visual e leitura com imagens dentro dos jogos.</p>
                        </div>
                    </article>
                    <article class="report-card">
                ...
                <article class="report-panel report-panel--wide">
                    ...
                    <div class="report-action-grid">
                        <article class="report-action-card">
                            ...
                            <p>Use vogais, s&iacute;labas e alfabeto para ampliar escolhas, fala, escuta e comunica&ccedil;&atilde;o alternativa.</p>
                            <a href="#jogos">Ver jogos</a>
                        </article>
                        <article class="report-action-card">
                            <strong>Percep&ccedil;&atilde;o visual e matem&aacute;tica</strong>
                            <p>Use cores, n&uacute;meros e matem&aacute;tica visual para trabalhar reconhecimento, associa&ccedil;&atilde;o, contagem e compara&ccedil;&atilde;o.</p>
